                        ...
                        <RadioForm
                            ...
                            {/* To create radio buttons, loop through your array of options */}
                            {
                                ...
                                <RadioButton labelHorizontal={true} key={i} >
                                    ...
                                    buttonOuterColor={this.state.statusetatcivil === i ? 'black' : '#000'}
                                    buttonSize={20}
                                    buttonOuterSize={50}
                                    buttonStyle={{}}
    ...
    if (this.state.current === 1) {
                        ...
                        <RadioForm
                            ...
                            {/* To create radio buttons, loop through your array of options */}
                            {
                                ...
                                <RadioButton labelHorizontal={true} key={i} >
                                    ...
                                    borderWidth={1}
                                    buttonInnerColor={'black'}
                                    buttonOuterColor={this.state.value3Index === i ? 'black' : '#000'}
                                    buttonSize={20}
                                    buttonOuterSize={50}
                                    buttonStyle={{}}
                                    buttonWrapStyle={{marginLeft: 180}}
                                    />
                                    <RadioButtonLabel
                                    obj={obj}
                                    index={i}
        ...
        return (
            ...
            <TouchableWithoutFeedback onPress={() => this._onPresstestanalys("no")}>
                ...
                {this.state.statustestanalys==="yes" ? (
              <View style={{ flex: 10}}>
                <Text style={styles.textlabel}></Text> 
        ...
        return (
            ...
            <TouchableWithoutFeedback onPress={() => this._onPressstatuszonecritique("no")}>
             ...
             {this.state.statuszonecritique==="yes" ? (
              <View style={{ flex: 10}}>
                <Text style={styles.textlabel}></Text> 
                <Text style={styles.textlabel}>  حدد المنطقة {br} {br}</Text> 
            <Text style={styles.textlabel}>  متى قمت بزيارتها {br} {br}</Text> 
